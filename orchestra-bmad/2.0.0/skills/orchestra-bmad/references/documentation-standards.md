...
CommonMark standards, technical writing best practices, and style guide compliance for all BMAD documentation outputs.
...
- Hierarchical order: do not skip levels (h1 then h2 then h3, not h1 then h3)
...
- Consistent markers within list: all `-` or all `*` or all `+` (do not mix)
...
- NO single line breaks (they are ignored)
...
3. Mentally validate syntax before outputting
...
- Alt text for diagrams: describe what the diagram shows
- Semantic heading hierarchy (do not skip levels)
- Tables have headers
